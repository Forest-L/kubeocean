...
var BootStrapTmpl = template.Must(template.New("kubeadmCfg").Parse(
...
systemctl stop firewald && systemctl disable firewald> /dev/null
systemctl stop ufw && systemctl disable ufw > /dev/null
